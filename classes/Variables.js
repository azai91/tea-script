...
var hoistVariables = function (bufferArray) {
  ...
  for (var i = 0; i < bufferArray.length; i++) {
    ...
    console.log('one');
    console.log('bitch', undeclaredVariableList[undeclaredVariableList.length - 1][1]);
    console.log(undeclaredVariableList[undeclaredVariableList.length - 1]);
